...
function SetCarToCompare(el, carClass) {
    ...
    if (el.checked && carArr.length >= 2) {
        alert("Você só pode comparar 2 carros ao mesmo tempo")
...
function UpdateCompareTable() {
    ...
    document.getElementById("compare_image_0").innerHTML = `<img src = "${compare0.image}" width="150px">`;
    document.getElementById("compare_image_1").innerHTML = `<img src = "${compare1.image}" width="150px">`;
